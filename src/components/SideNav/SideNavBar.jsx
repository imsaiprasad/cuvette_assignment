  ...
  return (
    <div className="navMain">
      <div className="d-flex justify-content-center">
        <span className="d-flex justify-content-start navLinkInner m-3 mt-5">
          <div className="d-flex align-items-center navLink">
            ...
            <Link className="navLink ms-2" to="/">
              Dashboard
            </Link>
          </div>
        </span>
      ...
      <div className="d-flex justify-content-center">
        <span className="d-flex justify-content-start navLinkInner m-3">
          <div className="d-flex align-items-center navLink">
...
<rect width="16" height="16" fill="white"/>
            ...
            <Link className="navLink active ms-2 " to="/">
              Skill Test
            </Link>
          </div>
        </span>
